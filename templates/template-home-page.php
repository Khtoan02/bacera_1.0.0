        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="flex flex-col gap-7 pt-6 lg:pt-0">
                <div class="flex flex-col gap-3">
                    ...
                    <p class="text-stone-600 text-body-reg font-sans leading-relaxed">Our hands move not to rush, but to listen: to the clay, to the wheel, and to the spaces in between. Each creation is shaped through patient hands, fired through ancient techniques, and glazed with emotions that words can hardly capture.</p>
                    <p class="text-stone-600 text-body-reg font-sans leading-relaxed">No two pieces are exactly alike — just as no two moments in life are ever the same.</p>
                </div>
                <div class="grid grid-cols-3 gap-4 py-6 border-y border-accent/20">
                    <?php foreach([[$hp_stat_years.'+','Years of craft'],[$hp_stat_products>0?hp_fmt($hp_stat_products):'100+','Pieces crafted'],[$hp_stat_customers>0?hp_fmt($hp_stat_customers):'1.2K+','Happy customers']] as $st): ?>
                    <div class="flex flex-col gap-1">
                        <span class="text-textmain text-3xl font-serif font-normal"><?php echo $st[0]; ?></span>
                        <span class="text-textmuted text-sm font-sans"><?php echo $st[1]; ?></span>
                    </div>
                    <?php endforeach; ?>
                </div>
