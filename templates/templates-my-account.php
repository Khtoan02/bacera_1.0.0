<?php
/**
 * Template Name: Tài khoản của tôi
 */
...
<div style="max-width:1200px;margin:0 auto;display:flex;flex-direction:column;gap:32px;">
    ...
    <div>
        <div style="display:flex;align-items:center;gap:6px;font-size:14px;font-weight:500;margin-bottom:12px;">
            ...
            <span style="color:#a8a29e;">Tài khoản</span>
        </div>
        <h1 style="font-size:clamp(28px,4vw,40px);font-weight:700;color:#1c1917;font-family:'Gowun Batang',serif;margin:0;">
            Xin chào, <span style="color:#c05a43;"><?php echo esc_html($cust_name ?: 'Bạn'); ?></span>
        </h1>
    </div>
    ...
    <div style="display:flex;gap:24px;align-items:flex-start;flex-wrap:wrap;">
        ...
        <aside style="width:260px;flex-shrink:0;background:#fff;border:1.5px solid #e7e5e4;border-radius:16px;padding:16px;display:flex;flex-direction:column;gap:4px;position:sticky;top:96px;">
            ...
            <?php
            $sidebar_tabs = [
                'account'   => ['icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', 'label' => 'Thông tin tài khoản'],
                'address'   => ['icon' => 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z', 'label' => 'Sổ địa chỉ giao hàng'],
                'orders'    => ['icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', 'label' => 'Đơn hàng của tôi'],
                'workshops' => ['icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', 'label' => 'Workshop đã đăng ký'],
            ];
        ...
        <div style="flex:1;min-width:0;background:#fff;border:1.5px solid #e7e5e4;border-radius:16px;padding:clamp(24px,5vw,56px);">
            ...
            <div id="panel-account" class="ma-panel active">
                ...
                <div class="ma-section-row">
                    <div class="ma-section-info">
                        <h2 class="ma-section-heading">Thông tin tài khoản</h2>
                        <p class="ma-section-desc">Thông tin này dùng để đăng nhập và hiển thị khi bình luận.</p>
                    </div>
                    <div class="ma-section-content">
                        <form id="form-account">
                            <div class="ma-input-row" style="margin-bottom:8px;">
                                <input type="text" id="input-first-name" class="ma-input" placeholder="Họ" value="<?php echo esc_attr($first_name); ?>" style="flex:1;">
                                <input type="text" id="input-last-name" class="ma-input" placeholder="Tên" value="<?php echo esc_attr($last_name); ?>" style="flex:1;">
                            </div>
                            <div style="position:relative; margin-bottom:8px;">
                                <input type="text" class="ma-input" placeholder="Điện thoại" value="<?php echo esc_attr($cust_phone); ?>" disabled>
                            ...
                            <button type="submit" class="ma-btn-primary">Lưu</button>
                        </form>
                    </div>
                </div>
                ...
                <div class="ma-section-row">
                    <div class="ma-section-info">
                        ...
                        <p class="ma-section-desc">Tùy chỉnh nhận thông báo email về giảm giá sản phẩm, workshop.</p>
                    </div>
                    <div class="ma-section-content">
                        <form id="form-notifications" onsubmit="event.preventDefault()">
                            <label class="ma-checkbox-wrap">
                                ...
                                <span style="font-size:15px;color:#1c1917;line-height:1.5;">Nhận thông báo Email khi có khuyến mãi hoặc sản phẩm mới</span>
                            </label>
                            <button type="submit" class="ma-btn-primary">Lưu</button>
                        </form>
                    </div>
                ...
                <div class="ma-section-row">
                    <div class="ma-section-info">
                        <h2 class="ma-section-heading">Đổi mật khẩu</h2>
                    </div>
                    <div class="ma-section-content">
                        <form id="form-password-change">
                            <div class="ma-pw-wrap" style="margin-bottom:8px;">
                                <input id="old-password" class="ma-input" type="password" placeholder="Mật khẩu cũ">
                            ...
                            <div class="ma-pw-wrap" style="margin-bottom:8px;">
                                <input id="new-password" class="ma-input" type="password" placeholder="Mật khẩu mới">
                                <button type="button" class="ma-pw-toggle" onclick="togglePw(this)">
                                    <svg class="eye-on" width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                    <svg class="eye-off" width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="display:none"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
                                </button>
                            ...
                            <div class="ma-pw-wrap" style="margin-bottom:8px;">
                                <input id="confirm-password" class="ma-input" type="password" placeholder="Nhập lại mật khẩu mới">
                                <button type="button" class="ma-pw-toggle" onclick="togglePw(this)">
                                    <svg class="eye-on" width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                    <svg class="eye-off" width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="display:none"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
                                </button>
                            ...
                            <div style="font-size:13px;color:#78716c;margin-bottom:24px;line-height:1.6;opacity:0.8;">
                                Tối thiểu 8 ký tự<br>1 chữ thường và 1 chữ hoa<br>1 ký tự đặc biệt
                            </div>
                            <button type="submit" class="ma-btn-primary">Lưu</button>
                        </form>
                    </div>
            ...
            <div id="panel-address" class="ma-panel">
                <div style="margin-bottom:28px;">
                    <p class="ma-section-heading">Sổ địa chỉ giao hàng</p>
                    <p class="ma-section-desc">Quản lý các địa chỉ giao hàng của bạn.</p>
                </div>
                <div style="display:flex;align-items:center;justify-content:center;flex-direction:column;gap:16px;padding:60px 0;color:#a8a29e;">
                    ...
                    <p style="font-size:15px;">Bạn chưa có địa chỉ nào.</p>
                    <button class="ma-btn-primary dark">Thêm địa chỉ mới</button>
                </div>
            </div>
            ...
            <div id="panel-orders" class="ma-panel">
                <div style="margin-bottom:28px;">
                    <p class="ma-section-heading">Đơn hàng của tôi</p>
                    <p class="ma-section-desc">Lịch sử các đơn hàng đã đặt.</p>
                </div>
                <div style="display:flex;align-items:center;justify-content:center;flex-direction:column;gap:16px;padding:60px 0;color:#a8a29e;">
                    ...
                    <a href="<?php echo esc_url(home_url('/shop')); ?>" class="ma-btn-primary dark">Khám phá cửa hàng</a>
                </div>
            </div>
            ...
            <div id="panel-workshops" class="ma-panel">
                <div style="margin-bottom:28px;">
                    <p class="ma-section-heading">Workshop đã đăng ký</p>
                    <p class="ma-section-desc">Các lớp học gốm bạn đã đặt.</p>
                </div>
                <div style="display:flex;align-items:center;justify-content:center;flex-direction:column;gap:16px;padding:60px 0;color:#a8a29e;">
                    ...
                    <p style="font-size:15px;">Bạn chưa đăng ký workshop nào.</p>
                    <a href="<?php echo esc_url(home_url('/workshop')); ?>" class="ma-btn-primary dark">Xem Workshop</a>
                </div>
            </div>
    ...
    <div class="ma-modal">
        ...
        <div id="modal-step1">
            ...
            <div style="display:flex;gap:12px;">
                <button class="ma-btn-primary dark" style="flex:1;" id="modal-send-otp" onclick="sendOtp()">Gửi mã OTP</button>
                <button class="ma-btn-secondary" style="flex:1;" onclick="closeEditModal()">Huỷ</button>
            </div>
        </div>

        <!-- Step 2 -->
        <div id="modal-step2" style="display:none;">
            <p style="font-size:15px;color:#57534e;margin-bottom:20px;line-height:1.5;">Nhập mã 4 chữ số đã được gửi đến <strong id="modal-sent-to" style="color:#1c1917;"></strong></p>
            ...
            <div style="display:flex;gap:12px;">
                <button class="ma-btn-primary dark" style="flex:1;" onclick="verifyOtp()">Xác nhận</button>
                <button class="ma-btn-secondary" style="flex:1;" onclick="document.getElementById('modal-step1').style.display='';document.getElementById('modal-step2').style.display='none';document.getElementById('modal-alert').className='ma-alert';">Quay lại</button>
            </div>
        </div>
    </div>
</div>

<!-- Modal 2: Xác thực đổi mật khẩu -->
<div id="pw-verify-modal" class="ma-modal-overlay" onclick="if(event.target===this)closePwModal()">
    <div class="ma-modal">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px;">
            <h3 style="font-size:20px;font-weight:700;color:#1c1917;margin:0;">Xác thực tài khoản</h3>
        ...
        <div id="pw-modal-step1">
            <p style="font-size:15px;color:#57534e;margin-bottom:16px;line-height:1.5;">Vui lòng nhập Email hoặc SĐT đăng ký của bạn để nhận mã xác nhận đổi mật khẩu.</p>
            <input id="pw-verify-contact" class="ma-input" type="text" placeholder="Email hoặc SĐT" style="margin-bottom:24px;">
            <div style="display:flex;gap:12px;">
                <button class="ma-btn-primary dark" style="flex:1;" id="pw-btn-send" onclick="sendPwOtp()">Gửi mã OTP</button>
                <button class="ma-btn-secondary" style="flex:1;" onclick="closePwModal()">Huỷ</button>
            </div>
        </div>

        <!-- Step 2: Nhập OTP -->
        <div id="pw-modal-step2" style="display:none;">
            <p style="font-size:15px;color:#57534e;margin-bottom:20px;line-height:1.5;">Nhập mã 4 chữ số đã được gửi đến <strong id="pw-sent-to" style="color:#1c1917;"></strong></p>
            ...
            <div style="display:flex;gap:12px;">
                <button class="ma-btn-primary dark" style="flex:1;" onclick="submitPwChange()">Xác nhận & Đổi MK</button>
                <button class="ma-btn-secondary" style="flex:1;" onclick="document.getElementById('pw-modal-step1').style.display='';document.getElementById('pw-modal-step2').style.display='none';document.getElementById('pw-modal-alert').className='ma-alert';">Quay lại</button>
            </div>
        </div>
    </div>
</div>
...
(function() {
    ...
    document.getElementById('form-account').addEventListener('submit', async function(e) {
        ...
        if (!name) { showAlert('alert-account-global', 'Vui lòng nhập họ tên.', 'error'); return; }
        ...
        if (r && r.success) showAlert('alert-account-global','✓ Đã lưu thông tin thành công.','success');
        else showAlert('alert-account-global', r?.data?.message || 'Có lỗi xảy ra.', 'error');
    });
    ...
    window.sendOtp = async function() {
        ...
        if (!newValue) { showAlert('modal-alert', 'Vui lòng nhập thông tin.', 'error'); return; }
        ...
        if (r && r.success) {
            ...
            showAlert('modal-alert', r?.data?.message || 'Có lỗi xảy ra.', 'error');
        }
    };

    window.verifyOtp = async function() {
        const otp = [...document.querySelectorAll('#modal-otp-boxes .ma-otp-box')].map(b=>b.value).join('');
        if (otp.length !== 4) { showAlert('modal-alert','Vui lòng nhập đủ 4 số.','error'); return; }
        const fd = new FormData();
        ...
        if (r && r.success) {
            closeEditModal();
            showAlert('alert-account-global', '✓ Cập nhật thành công! Đang tải lại...', 'success');
            setTimeout(() => location.reload(), 1200);
        } else {
            showAlert('modal-alert', r?.data?.message || 'Mã OTP không đúng.', 'error');
        }
    };
    ...
    document.getElementById('form-password-change').addEventListener('submit', function(e) {
        ...
        if (!old_pw || !new_pw || !conf_pw) { showAlert('alert-account-global','Vui lòng điền đủ form đổi mật khẩu.','error'); return; }
        if (new_pw !== conf_pw) { showAlert('alert-account-global','Mật khẩu xác nhận không khớp.','error'); return; }
        if (new_pw.length < 8)  { showAlert('alert-account-global','Mật khẩu tối thiểu 8 ký tự.','error'); return; }
    ...
    window.sendPwOtp = async function() {
        ...
        if (!contact) { showAlert('pw-modal-alert', 'Vui lòng nhập Email hoặc SĐT.', 'error'); return; }
    ...
    window.submitPwChange = async function() {
        ...
        if (otp.length !== 4) { showAlert('pw-modal-alert','Vui lòng nhập đủ 4 số.','error'); return; }
        ...
        btn.disabled = false; btn.textContent = 'Xác nhận & Đổi MK';
        if (r && r.success) {
            closePwModal();
