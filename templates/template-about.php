...
<div class="font-sans antialiased bg-texture text-[#2C2824] selection:bg-accentdark selection:text-white w-full overflow-hidden">
    ...
    <!-- 1. HERO SECTION -->
    <section class="bacera-container pt-12 pb-24 relative">
    ...
    <!-- Art Divider -->
    <div class="w-full bacera-container py-12">
        <div class="w-full h-[1px] divider-art opacity-60"></div>
    </div>

    <!-- 2. CRAFTING PHILOSOPHY -->
    <section class="bacera-container section-pad">
    ...
    <!-- 6. REVIEWS -->
    <section class="bacera-container section-pad mb-10 relative bg-textmain text-bgtheme rounded-3xl lg:rounded-[60px] overflow-hidden">
