    ...
    private function render_scripts( string $nonce ) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function openDrawer(id) {
                ...
                var lnF = $('#tmm-line');   if (lnF) lnF.value = m.line_app || '';
